...
/**
 * /shopee header — leaner than the home header. The page is short and has
 * no in-page anchors, so section navigation is removed. Just logo + a
 * persistent yellow WhatsApp CTA + click-to-call on mobile.
 *
 * The .shopee-theme wrapper (on the page root) recolors --primary to
 * Shopee orange; the CTA button is explicitly the Shopee yellow
 * (bg-secondary) for the "buy now" feel sellers recognize.
 */
export const HeaderShopee = () => {
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between gap-4 sm:gap-8">
          ...
          {/* Desktop: single CTA, no nav (page is short, no anchors). */}
          <div className="hidden xl:flex items-center gap-6">
            ...
            <a
              href={whatsappLink('shopee-header')}
              target="_blank"
            ...
            >
              <Button
                size="sm"
                className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold py-3 px-6 sm:px-8 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
