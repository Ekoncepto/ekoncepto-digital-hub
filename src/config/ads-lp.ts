...
export const ADS_LPS: Record<string, AdsLPConfig> = {
  ...
  'mercado-livre': {
    ...
    heroHeadline: 'Suas vendas no Mercado Livre estagnaram? Tem alavanca que você não está usando.',
    heroSub: `Estratégia de Mercado Ads, Buy Box e reposição que já gerou +R$ 241M em marketplaces.`,
    primaryHex: '#FFE600',
  ...
  amazon: {
    ...
    heroHeadline: 'Você está perdendo o Buy Box na Amazon? Cada dia sem ele é venda indo pro concorrente.',
    heroSub: `FBA, A+ Content e SEO Amazon para dominar a maior marketplace do mundo.`,
    primaryHex: '#FF9900',
